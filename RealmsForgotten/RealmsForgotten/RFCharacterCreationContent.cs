...
namespace RealmsForgotten
{
  public class RFCharacterCreationContent : SandboxCharacterCreationContent
  {
    ...
    protected new void AddParentsMenu(CharacterCreation characterCreation)
    {
      ...
      creationCategory1.AddCategoryOption(new TextObject("Direct Descendants of the first people."), effectedSkills1, vigor1, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, (CharacterCreationOnCondition) null, new CharacterCreationOnSelect((this).EmpireLandlordsRetainerOnConsequence), new CharacterCreationApplyFinalEffects(( this).EmpireLandlordsRetainerOnApply), new TextObject("{=ivKl4mV2}Descending from the ruler´s bloodline of the First People - the ancestors that made the pilgrimage to Aeurth - your father was a leader among his village and the cousin of the King of his Realm. He rode with the lord´s cavalry, fighting as an armored lancer."));
      ...
      creationCategory1.AddCategoryOption(new TextObject("Free Farmers"), effectedSkills3, endurance1, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, (CharacterCreationOnCondition) null, new CharacterCreationOnSelect(( this).EmpireFreeholderOnConsequence), new CharacterCreationApplyFinalEffects(( this).EmpireFreeholderOnApply), new TextObject("{=09z8Q08f}Your family were small farmers with just enough land to feed themselves and make a small profit. People like them were the pillars of the realm rural economy, as well as the backbone of the levy."));
      ...
      creationCategory1.AddCategoryOption(new TextObject("{=v48N6h1t}Urban artisans"), effectedSkills4, intelligence1, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, (CharacterCreationOnCondition) null, new CharacterCreationOnSelect(( this).EmpireArtisanOnConsequence), new CharacterCreationApplyFinalEffects(( this).EmpireArtisanOnApply), new TextObject("{=ZKynvffv}Your family owned their own workshop in a city, making goods from raw materials brought in from the countryside. Your father played an active if minor role in the town council, and also served in the militia."));
      ...
      creationCategory1.AddCategoryOption(new TextObject("{=aEke8dSb}Urban vagabonds"), effectedSkills6, cunning1, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, (CharacterCreationOnCondition) null, new CharacterCreationOnSelect(( this).EmpireVagabondOnConsequence), new CharacterCreationApplyFinalEffects(( this).EmpireVagabondOnApply), new TextObject("{=Jvf6K7TZ}Your family numbered among the many poor migrants living in the slums that grow up outside the walls of cities, making whatever money they could from a variety of odd jobs. Sometimes they did service for one of the many criminal gangs, and you had an early look at the dark side of life."));
      ...
      creationCategory2.AddCategoryOption(new TextObject("Retainers of the Qairth"), effectedSkills7, social2, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, (CharacterCreationOnCondition) null, new CharacterCreationOnSelect(( this).VlandiaBaronsRetainerOnConsequence), new CharacterCreationApplyFinalEffects(( this).VlandiaBaronsRetainerOnApply), new TextObject("Your father was a bailiff for a local Qairth. He looked after his Qairth's estates, resolved disputes in the village, and helped train the village levy. He rode with the Qairth's cavalry, fighting as an armored knight."));
      ...
      creationCategory2.AddCategoryOption(new TextObject("Guildmerchants"), effectedSkills8, intelligence2, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, (CharacterCreationOnCondition) null, new CharacterCreationOnSelect(( this).VlandiaMerchantOnConsequence), new CharacterCreationApplyFinalEffects(( this).VlandiaMerchantOnApply), new TextObject("{=qNZFkxJb}Your family were merchants in one of the main cities of the kingdom. They organized caravans to nearby towns and were active in the local merchant's guild."));
      ...
      creationCategory2.AddCategoryOption(new TextObject("{=p2KIhGbE}Urban blacksmith"), effectedSkills10, vigor2, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, (CharacterCreationOnCondition) null, new CharacterCreationOnSelect(( this).VlandiaBlacksmithOnConsequence), new CharacterCreationApplyFinalEffects(( this).VlandiaBlacksmithOnApply), new TextObject("{=btsMpRcA}Your family owned a smithy in a city. Your father played an active if minor role in the town council, and also served in the militia."));
      ...
      creationCategory2.AddCategoryOption(new TextObject("{=YcnK0Thk}Hunters"), effectedSkills11, control2, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, (CharacterCreationOnCondition) null, new CharacterCreationOnSelect(( this).VlandiaHunterOnConsequence), new CharacterCreationApplyFinalEffects(( this).VlandiaHunterOnApply), new TextObject("{=yRFSzSDZ}Your family lived in a village, but did not own their own land. Instead, your father supplemented paid jobs with long trips in the woods, hunting and trapping, always keeping a wary eye for the lord's game wardens."));
    ...
    protected new void AddEducationMenu(CharacterCreation characterCreation)
    {
      ...
      int skillLevelToAdd2 = this.SkillLevelToAdd;
      int attributeLevelToAdd2 = this.AttributeLevelToAdd;
      CharacterCreationOnCondition optionCondition2 = new CharacterCreationOnCondition(( this).BattanianParentsOnCondition);
    ...
    protected new void AddYouthMenu(CharacterCreation characterCreation)
    {
      ...
      CharacterCreationCategory creationCategory1 = menu.AddMenuCategory(new CharacterCreationOnCondition(( this).AseraiParentsOnCondition));
      CharacterCreationCategory creationCategory2 = creationCategory1;
      ...
      int skillLevelToAdd1 = this.SkillLevelToAdd;
      int attributeLevelToAdd1 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect1 = new CharacterCreationOnSelect(( this).YouthCavalryOnConsequence);
      CharacterCreationApplyFinalEffects onApply1 = new CharacterCreationApplyFinalEffects(( this).YouthCavalryOnApply);
      ...
      int skillLevelToAdd2 = this.SkillLevelToAdd;
      int attributeLevelToAdd2 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect2 = new CharacterCreationOnSelect(( this).YouthGarrisonOnConsequence);
      CharacterCreationApplyFinalEffects onApply2 = new CharacterCreationApplyFinalEffects(( this).YouthGarrisonOnApply);
      ...
      int skillLevelToAdd3 = this.SkillLevelToAdd;
      int attributeLevelToAdd3 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect3 = new CharacterCreationOnSelect(( this).YouthOtherOutridersOnConsequence);
      CharacterCreationApplyFinalEffects onApply3 = new CharacterCreationApplyFinalEffects(( this).YouthOtherOutridersOnApply);
      ...
      int skillLevelToAdd4 = this.SkillLevelToAdd;
      int attributeLevelToAdd4 = this.AttributeLevelToAdd;
      CharacterCreationApplyFinalEffects onApply4 = new CharacterCreationApplyFinalEffects(( this).YouthInfantryOnApply);
      ...
      int skillLevelToAdd5 = this.SkillLevelToAdd;
      int attributeLevelToAdd5 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect4 = new CharacterCreationOnSelect(( this).YouthSkirmisherOnConsequence);
      CharacterCreationApplyFinalEffects onApply5 = new CharacterCreationApplyFinalEffects(( this).YouthSkirmisherOnApply);
      ...
      int skillLevelToAdd6 = this.SkillLevelToAdd;
      int attributeLevelToAdd6 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect5 = new CharacterCreationOnSelect(( this).YouthCamperOnConsequence);
      CharacterCreationApplyFinalEffects onApply6 = new CharacterCreationApplyFinalEffects(( this).YouthCamperOnApply);
      ...
      CharacterCreationCategory creationCategory8 = menu.AddMenuCategory(new CharacterCreationOnCondition(( this).BattanianParentsOnCondition));
      ...
      int skillLevelToAdd7 = this.SkillLevelToAdd;
      int attributeLevelToAdd7 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect6 = new CharacterCreationOnSelect(( this).YouthCavalryOnConsequence);
      CharacterCreationApplyFinalEffects onApply7 = new CharacterCreationApplyFinalEffects(( this).YouthCavalryOnApply);
      ...
      int skillLevelToAdd8 = this.SkillLevelToAdd;
      int attributeLevelToAdd8 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect7 = new CharacterCreationOnSelect(( this).YouthGarrisonOnConsequence);
      CharacterCreationApplyFinalEffects onApply8 = new CharacterCreationApplyFinalEffects(( this).YouthGarrisonOnApply);
      ...
      int skillLevelToAdd9 = this.SkillLevelToAdd;
      int attributeLevelToAdd9 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect8 = new CharacterCreationOnSelect(( this).YouthOtherOutridersOnConsequence);
      ...
      int skillLevelToAdd11 = this.SkillLevelToAdd;
      int attributeLevelToAdd11 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect9 = new CharacterCreationOnSelect(( this).YouthCamperOnConsequence);
      CharacterCreationApplyFinalEffects onApply11 = new CharacterCreationApplyFinalEffects(( this).YouthCamperOnApply);
      ...
      CharacterCreationCategory creationCategory14 = menu.AddMenuCategory(new CharacterCreationOnCondition(( this).EmpireParentsOnCondition));
      ...
      int skillLevelToAdd12 = this.SkillLevelToAdd;
      int attributeLevelToAdd12 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect10 = new CharacterCreationOnSelect(( this).YouthCavalryOnConsequence);
      CharacterCreationApplyFinalEffects onApply12 = new CharacterCreationApplyFinalEffects(( this).YouthCavalryOnApply);
      ...
      int skillLevelToAdd13 = this.SkillLevelToAdd;
      int attributeLevelToAdd13 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect11 = new CharacterCreationOnSelect(( this).YouthGarrisonOnConsequence);
      CharacterCreationApplyFinalEffects onApply13 = new CharacterCreationApplyFinalEffects(( this).YouthGarrisonOnApply);
      ...
      int skillLevelToAdd14 = this.SkillLevelToAdd;
      int attributeLevelToAdd14 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect12 = new CharacterCreationOnSelect(( this).YouthSkirmisherOnConsequence);
      CharacterCreationApplyFinalEffects onApply14 = new CharacterCreationApplyFinalEffects(( this).YouthSkirmisherOnApply);
      ...
      int skillLevelToAdd15 = this.SkillLevelToAdd;
      int attributeLevelToAdd15 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect13 = new CharacterCreationOnSelect(( this).YouthOtherOutridersOnConsequence);
      CharacterCreationApplyFinalEffects onApply15 = new CharacterCreationApplyFinalEffects(( this).YouthOtherOutridersOnApply);
      ...
      int skillLevelToAdd16 = this.SkillLevelToAdd;
      int attributeLevelToAdd16 = this.AttributeLevelToAdd;
      CharacterCreationApplyFinalEffects onApply16 = new CharacterCreationApplyFinalEffects(( this).YouthInfantryOnApply);
      ...
      int skillLevelToAdd17 = this.SkillLevelToAdd;
      int attributeLevelToAdd17 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect14 = new CharacterCreationOnSelect(( this).YouthCamperOnConsequence);
      CharacterCreationApplyFinalEffects onApply17 = new CharacterCreationApplyFinalEffects(( this).YouthCamperOnApply);
      ...
      CharacterCreationCategory creationCategory21 = menu.AddMenuCategory(new CharacterCreationOnCondition(( this).VlandianParentsOnCondition));
      ...
      int skillLevelToAdd18 = this.SkillLevelToAdd;
      int attributeLevelToAdd18 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect15 = new CharacterCreationOnSelect(( this).YouthCavalryOnConsequence);
      CharacterCreationApplyFinalEffects onApply18 = new CharacterCreationApplyFinalEffects(( this).YouthCavalryOnApply);
      ...
      int skillLevelToAdd19 = this.SkillLevelToAdd;
      int attributeLevelToAdd19 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect16 = new CharacterCreationOnSelect(( this).YouthGarrisonOnConsequence);
      CharacterCreationApplyFinalEffects onApply19 = new CharacterCreationApplyFinalEffects(( this).YouthGarrisonOnApply);
      ...
      int skillLevelToAdd20 = this.SkillLevelToAdd;
      int attributeLevelToAdd20 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect17 = new CharacterCreationOnSelect(( this).YouthSkirmisherOnConsequence);
      CharacterCreationApplyFinalEffects onApply20 = new CharacterCreationApplyFinalEffects(( this).YouthSkirmisherOnApply);
      ...
      int skillLevelToAdd21 = this.SkillLevelToAdd;
      int attributeLevelToAdd21 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect18 = new CharacterCreationOnSelect(( this).YouthOtherOutridersOnConsequence);
      CharacterCreationApplyFinalEffects onApply21 = new CharacterCreationApplyFinalEffects(( this).YouthOtherOutridersOnApply);
      ...
      int skillLevelToAdd22 = this.SkillLevelToAdd;
      int attributeLevelToAdd22 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect19 = new CharacterCreationOnSelect(( this).YouthInfantryOnConsequence);
      CharacterCreationApplyFinalEffects onApply22 = new CharacterCreationApplyFinalEffects(( this).YouthInfantryOnApply);
      ...
      int skillLevelToAdd23 = this.SkillLevelToAdd;
      int attributeLevelToAdd23 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect20 = new CharacterCreationOnSelect(( this).YouthCamperOnConsequence);
      CharacterCreationApplyFinalEffects onApply23 = new CharacterCreationApplyFinalEffects(( this).YouthCamperOnApply);
      ...
      CharacterCreationCategory creationCategory28 = menu.AddMenuCategory(new CharacterCreationOnCondition(( this).KhuzaitParentsOnCondition));
      ...
      int skillLevelToAdd24 = this.SkillLevelToAdd;
      int attributeLevelToAdd24 = this.AttributeLevelToAdd;
      CharacterCreationOnSelect onSelect21 = new CharacterCreationOnSelect(( this).YouthCavalryOnConsequence);
      CharacterCreationApplyFinalEffects onApply24 = new CharacterCreationApplyFinalEffects(( this).YouthCavalryOnApply);
      ...
      CharacterCreationOnSelect onSelect22 = new CharacterCreationOnSelect(( this).YouthGarrisonOnConsequence);
      CharacterCreationApplyFinalEffects onApply25 = new CharacterCreationApplyFinalEffects(( this).YouthGarrisonOnApply);
      ...
      CharacterCreationOnSelect onSelect23 = new CharacterCreationOnSelect(( this).YouthSkirmisherOnConsequence);
      CharacterCreationApplyFinalEffects onApply26 = new CharacterCreationApplyFinalEffects(( this).YouthSkirmisherOnApply);
      ...
      CharacterCreationOnSelect onSelect24 = new CharacterCreationOnSelect(( this).YouthOtherOutridersOnConsequence);
      CharacterCreationApplyFinalEffects onApply27 = new CharacterCreationApplyFinalEffects(( this).YouthOtherOutridersOnApply);
      ...
      CharacterCreationApplyFinalEffects onApply28 = new CharacterCreationApplyFinalEffects(( this).YouthInfantryOnApply);
      ...
      CharacterCreationOnSelect onSelect25 = new CharacterCreationOnSelect(( this).YouthCamperOnConsequence);
      CharacterCreationApplyFinalEffects onApply29 = new CharacterCreationApplyFinalEffects(( this).YouthCamperOnApply);
      ...
      CharacterCreationCategory creationCategory35 = menu.AddMenuCategory(new CharacterCreationOnCondition(( this).SturgianParentsOnCondition));
      ...
      CharacterCreationOnSelect onSelect26 = new CharacterCreationOnSelect(( this).YouthCavalryOnConsequence);
      CharacterCreationApplyFinalEffects onApply30 = new CharacterCreationApplyFinalEffects(( this).YouthCavalryOnApply);
      ...
      CharacterCreationOnSelect onSelect27 = new CharacterCreationOnSelect(( this).YouthGarrisonOnConsequence);
      CharacterCreationApplyFinalEffects onApply31 = new CharacterCreationApplyFinalEffects(( this).YouthGarrisonOnApply);
      ...
      CharacterCreationOnSelect onSelect28 = new CharacterCreationOnSelect(( this).YouthSkirmisherOnConsequence);
      CharacterCreationApplyFinalEffects onApply32 = new CharacterCreationApplyFinalEffects(( this).YouthSkirmisherOnApply);
      ...
      CharacterCreationOnSelect onSelect29 = new CharacterCreationOnSelect(( this).YouthOtherOutridersOnConsequence);
      CharacterCreationApplyFinalEffects onApply33 = new CharacterCreationApplyFinalEffects(( this).YouthOtherOutridersOnApply);
      ...
      CharacterCreationOnSelect onSelect30 = new CharacterCreationOnSelect(( this).YouthInfantryOnConsequence);
      CharacterCreationApplyFinalEffects onApply34 = new CharacterCreationApplyFinalEffects(( this).YouthInfantryOnApply);
      ...
      CharacterCreationOnSelect onSelect31 = new CharacterCreationOnSelect(( this).YouthCamperOnConsequence);
      CharacterCreationApplyFinalEffects onApply35 = new CharacterCreationApplyFinalEffects(( this).YouthCamperOnApply);
    ...
    protected new void AddAdulthoodMenu(CharacterCreation characterCreation)
    {
      ...
      characterCreation.AddNewMenu(menu);
        ...
        {
            CharacterCreationMenu characterCreationMenu = new CharacterCreationMenu(new TextObject("{=CulturedStart07}Start Options", null), new TextObject("{=CulturedStart08}Who are you in Realms Forgotten...", null), new CharacterCreationOnInit(StartOnInit), CharacterCreationMenu.MenuTypes.MultipleChoice);
            ...
            // Merchant Start
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart11}A budding caravanner", null), new List<SkillObject> { DefaultSkills.Trade }, null, 1, 25, 0, null, new CharacterCreationOnSelect(MerchantStartOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart12}With what savings you could muster you purchased some mules and mercenaries.", null), null, 0, 0);

            // Exiled Start
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart13}A noble of {CULTURE} in exile", null), new List<SkillObject> { DefaultSkills.Leadership }, null, 1, 50, 0, null, new CharacterCreationOnSelect(ExiledStartOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart14}Forced into exile after your parents were executed for suspected treason. With only your family's bodyguard you set off. Should you return you'd be viewed as a criminal.", null), null, 0, 150);

            // Mercenary Start            
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart15}In a failing mercenary company", null), new List<SkillObject> { DefaultSkills.Tactics }, null, 1, 50, 0, null, new CharacterCreationOnSelect(MercenaryStartOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart16}With men deserting over lack of wages, your company leader was found dead, and you decided to take your chance and lead.", null), null, 0, 50);

            // Looter Start
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart17}A looter lowlife", null), new List<SkillObject> { DefaultSkills.Roguery }, null, 1, 25, 0, null, new CharacterCreationOnSelect(LooterStartOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart18}Left impoverished from war, you found a group of like-minded ruffians who were desperate to get by.", null), null, 0, 0);

            // Vassal Start
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart19}A new vassal of {CULTURE}", null), new List<SkillObject> { DefaultSkills.Steward }, null, 1, 50, 0, null, new CharacterCreationOnSelect(VassalStartOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart20}A young noble who came into an arrangement with the king for a chance at land.", null), null, 0, 150);

            // Kingdom Start
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart21}Leading part of {CULTURE}", null), new List<SkillObject> { DefaultSkills.Leadership, DefaultSkills.Steward }, DefaultCharacterAttributes.Social, 1, 50, 1, null, new CharacterCreationOnSelect(KingdomStartOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart22}With the support of companions you have gathered an army. With limited funds and food you decided it's time for action.", null), null, 0, 900);

            // Holding Start
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart23}You acquired a town", null), new List<SkillObject> { DefaultSkills.Leadership, DefaultSkills.Steward }, DefaultCharacterAttributes.Social, 1, 25, 1, null, new CharacterCreationOnSelect(HoldingStartOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart24}You acquired a town through your own means and declared yourself a kingdom for better or worse.", null), null, 0, 900);

            // Landed Vassal Start
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart25}A landed vassal of {CULTURE}", null), new List<SkillObject> { DefaultSkills.Steward }, null, 1, 50, 0, null, new CharacterCreationOnSelect(LandedVassalStartOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart26}A young noble who came into an arrangement with the king for land.", null), null, 0, 150);
        ...
        public void AddCultureLocationMenu(CharacterCreation characterCreation)
        {
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart35}In a caravan to the City States of Athas city of Qasira", null), new List<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(QasariLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart36}You leave the caravan right at the gates", null), null);

            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart37}In a caravan to the High Kingdom of the Elveans city of Dunglanys", null), new List<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(DunglanysLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart36}You leave the caravan right at the gates", null), null);

            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart38}On a ship to the Kingdoms of Men city of Zeonica", null), new List<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(ZeonicaLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart39}You leave the ship and arrive right at the gates", null), null);

            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart40}In a caravan to the Dreaddrealms city of Balgard", null), new List<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(BalgardLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart36}You leave the caravan right at the gates", null), null);

            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart41}In a caravan to the Al-Kuuhr city of Ortongard", null), new List<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(OrtongardLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart36}You leave the caravan right at the gates", null), null);

            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart42}On a river boat to the Easterners Tribes city of Pravend", null), new List<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(PravendLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart43}You leave the boat and arrive right at the gates", null), null);

            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart44}At your holding", null), new List<SkillObject>(), null, 0, 0, 0, new CharacterCreationOnCondition(CastleLocationOnCondition), new CharacterCreationOnSelect(CastleLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart45}At your newly acquired castle", null), null);
